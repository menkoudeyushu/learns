Shader "Unlit/TurnTransparent"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 ColorTurnTransparent(float2 uv, float speed)
            {
            ...
            n += SAMPLE_TEXTURE2D(_MainTex,sampler_MainTex,tuv).r * 0.61 + SAMPLE_TEXTURE2D(_MainTex,sampler_MainTex,tuv).g * 0.4 + SAMPLE_TEXTURE2D(_MainTex,sampler_MainTex,tuv).b * 0.2;
            n=fmod(n,1.0);
            float tx = n * 6.0;
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // sampler.
                float4 txt1  = SAMPLE_TEXTURE2D(_MainTex,sampler_MainTex,IN.texcoord); 
                //half4 _TurnTransparent_1 = ColorTurnTransparent(IN.texcoord,txt1,_TurnTransparent_Speed_1);
                float4 _TurnTransparent_1 = ColorTurnTransparent(IN.texcoord,_TurnTransparent_Speed_1);
